...
"NRELOffshrBsline5MW_InflowWind_steps_R3.dat"    InflowFile      - Name of file containing inflow wind input parameters (quoted string)
...
False         SumPrint        - Print summary data to "<RootName>.sum" (flag)
       ...
       2000   ChkptTime       - Amount of time between creating checkpoint files for potential restart (s)
